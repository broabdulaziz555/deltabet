...
import { LayoutDashboard, Users, ArrowDownLeft, ArrowUpRight, Tag, LogOut, Menu, X, Gamepad2, Sliders } from 'lucide-react'
...
const NAV = [
  ...
  { path: '/admin/algo',        icon: Sliders,         label: 'Algo Config' },
]
